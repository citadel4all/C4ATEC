...
const APIURL = `https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=${APIKEY}&include_adult=false&with_genres=28&certification_country=US&certification.gte=PG`;
const IMGPATH = "https://image.tmdb.org/t/p/w1280";
const SEARCHAPI = `https://api.themoviedb.org/3/search/movie?api_key=${APIKEY}&include_adult=false&with_genres=28&certification_country=US&certification.gte=PG&query=`;
